	...
	// write your code here
        ...
        public class ManyFunctions
        {
            ...
            public static int minimum(int a, int b)
            {
                ...
                // TODO change return to int & parameters to (int a, int b). Add if, else and return a/b;
            }
            ...
            public static int maximum(int c, int d)
            {
                ...
                // TODO change return to int & parameters to (int c, int d). Add if, else and return c/d;
            }
             ...
             */
             ...
             public static boolean isOddNumber(int number) {
                if ((number % 2) == 0) {
                     ...
                     return false;
                // TODO change return to boolean & parameters (int number). Add: if ((number divisible by 2)==0)
            }
            ...
            public static boolean isVowel(char v)
            {
                if (v == 'a') {
                    ...
                    return false;
                // TODO change return to char & parameter char v. Add if v == a, e, i, o, u) return true, else false.
            }
            ...
            public static boolean isConsonant(char c)
            {
                if (c != 'a') {
                    ...
                    return false;
                // TODO change return to char & parameter char c. Add if c != a, e, i, o, u) return true, else false.
            }
